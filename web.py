...
st.set_page_config(page_title='Prediction of Disease Outbreaks',
                   layout='wide',
                   page_icon='doctor')
diabetes_model= pickle.load(open(r"C:\Users\NILESH\OneDrive\Desktop\AICTE INTERNSHIP\Prediction Of Disease Outbreak\traning_models\diabetes_model.sav",'rb'))
heart_disease_model=pickle.load(open(r"C:\Users\NILESH\OneDrive\Desktop\AICTE INTERNSHIP\Prediction Of Disease Outbreak\traning_models\heart_model.sav",'rb'))
parkinsons_model=pickle.load(open(r"C:\Users\NILESH\OneDrive\Desktop\AICTE INTERNSHIP\Prediction Of Disease Outbreak\traning_models\parkinsons_model.sav",'rb'))

with st.sidebar:
    selected= option_menu('Prediction of disease outbreak system',['Diabetes Prediction','Heart Diseases Prediction','Parkinsons Prediction'],
...
if selected == 'Parkinsons Prediction':
    ...
    if st.button("Parkinson's Test Result"):
        user_input=[MDVP_Fo_Hz,MDVP_Fhi_Hz,MDVP_Flo_Hz,MDVP_Jitter,MDVP_Jitter_Abs,MDVP_RAP,MDVP_PPQ,Jitter_DDP,MDVP_Shimmer,MDVP_Shimmer_dB,Shimmer_APQ3,Shimmer_APQ5,MDVP_APQ,Shimmer_DDA,NHR,HNR,RPDE,DFA,spread1,spread2,D2,PPE]
        user_input=[float(x) for x in user_input]
